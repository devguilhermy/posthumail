        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="well">
                    ...
                    <p class="italic"><b>Use a website (<a href="https://encipher.it/" target="_blank">Encipher IT</a>,&nbsp;<a href="https://aesencryption.net/" target="_blank">AES Encryption</a>) or a software like <a href="https://gnupg.org/">GPG</a> (more secure) to encrypt text...</b></p>
                </div>
                <form id="form">
